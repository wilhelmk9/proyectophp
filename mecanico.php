...
<head>
    ...
    <title>Tareas de Mecánicos</title>
...
<body>
    <h1>Lista de Tareas - Mecánicos</h1>
    ...
    foreach ($tareasPorCategoria as $categoria => $tareas) {
        ...
        foreach ($tareas as $tarea) {
            ...
            echo "<td>
                    <a href='editar_tarea_mecanico.php?id=" . $tarea['id'] . "'>Editar</a> |
    ...
    <br>
    <a class="volver" href="crear_tarea_mecanico.php">Crear Nueva Tarea</a>
</body>
</html>
