...
$sql = "SELECT t.id, t.titulo, t.descripcion, t.fecha_vencimiento, t.prioridad, t.estado, c.nombre AS categoria
        ...
        WHERE c.nombre = 'mantenimiento'"; // Solo muestra las tareas de mantenimiento
...
<body>
    <h1>Lista de Tareas - Mantenimiento</h1>
    ...
    foreach ($tareasPorCategoria as $categoria => $tareas) {
        ...
        foreach ($tareas as $tarea) {
            ...
            echo "<td>
                    <a href='editar_tarea_mantenimiento.php?id=" . $tarea['id'] . "'>Editar</a> |
    ...
    <br>
    <a class="volver" href="crear_tarea_mantenimiento.php">Crear Nueva Tarea</a>
</body>
</html>
